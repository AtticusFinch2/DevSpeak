const String classify_prompt = """Multi-choice problem: Define the category of the transcript?
Categories:
- Not related to code
- Unfinished Thought
...
Category:
""";
const String code_prompt = """Use the speech-to-text transcript to output a new file of python code with the changes or continuation of the code requested. Do NOT add to the code what is not in the transcript, and no comments.  Format the code correctly with correct indentation. Variable names may be incorrectly transcribed. 
